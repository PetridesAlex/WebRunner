...
import { ProjectTicker } from '../ui/ProjectTicker'
...
export function Hero() {
  ...
  return (
    <section id="hero" className="hero" aria-labelledby="hero-heading">
      <div className="hero__top-bar" role="region" aria-label="Announcement">
        <div className="hero__top-bar-inner">
          <p className="hero__top-bar-text">
            ...
            {site.messengerLinks?.find((m) => m.id === 'whatsapp')?.href ? (
              <a
                href={site.messengerLinks.find((m) => m.id === 'whatsapp').href}
      ...
      <div className="hero__ticker" data-reveal>
        <p className="hero__ticker-label" aria-hidden>
